...
elseif(isset($_POST['token'])):
    foreach($dt["db_field"] as $k):
        $dt[$k]=isset($_SESSION['lp-service01_futoko02/ac01'][$k])?$_SESSION['lp-service01_futoko02/ac01'][$k]:'';
    endforeach;
else:
    $_SESSION['lp-service01_futoko02/ac01']=array();
endif;
...
isset($_POST["confirm_x"])
    ...
    */
    ...
    if($dt["err"]):
        ...
        $_SESSION['lp-service01_futoko02/ac01']=$dt;
