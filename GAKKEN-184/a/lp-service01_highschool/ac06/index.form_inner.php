...
if(isset($_POST['confirm_x'])):
?>
<button type="button" class="btn_box btn_box02 h_img fs40 white fwb tac back">入力内容を修正する</button>
<button type="button" class="btn_box h_img fs40 white fwb tac fin">この内容で送信する</button>
<?php
else:
?>
<button type="button" class="btn_box h_img fs40 white fwb tac confirm">入力内容を確認する</button>
<?php
endif;
