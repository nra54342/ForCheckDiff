...
$('#voiceSlide').slick({
  ...
  centerMode: true,
  variableWidth: true,
  prevArrow: '<div class="slick-prev"><img src="img/custom/voicePrev.png"></div>',
  nextArrow: '<div class="slick-next"><img src="img/custom/voiceNext.png"></div>'
});
...
$('#strSlide').slick({
  ...
  variableWidth: true,
  prevArrow: false,
  nextArrow: '<div class="slick-next"><img src="img/custom/ssNext.png"></div>'
});
