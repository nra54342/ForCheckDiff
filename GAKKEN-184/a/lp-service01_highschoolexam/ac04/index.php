...
elseif(isset($_POST['token'])):
    foreach($dt["db_field"] as $k):
        $dt[$k]=isset($_SESSION['lp-service01_highschoolexam/ac02'][$k])?$_SESSION['lp-service01_highschoolexam/ac02'][$k]:'';
    endforeach;
else:
    $_SESSION['lp-service01_highschoolexam/ac02']=array();
endif;
...
foreach($dt["db_field"] as $key){
    if(!(isset($_POST['confirm_x']))):
        $_POST[$key]=isset($_SESSION['lp-service01_highschoolexam/ac02'][$key])?$_SESSION['lp-service/ac01'][$key]:$dt[$key];
    endif;
...
isset($_POST["confirm_x"])
    ...
    */
    ...
    if($dt["err"]):
        ...
        $_SESSION['lp-service01_highschoolexam/ac02']=$dt;
        #$_SESSION['lp-service01_highschoolexam/ac02']=$_POST;
    endif;
...
";
    ...
    $to     = $admin["to"];
    //$to     = "kudo@kipply.jp";
    //$to     = "moribe@kipply.jp,h_todoroki@kipply.jp";
