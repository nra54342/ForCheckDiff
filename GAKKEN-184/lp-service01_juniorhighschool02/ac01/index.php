...
elseif(isset($_POST['token'])):
    foreach($dt["db_field"] as $k):
        $dt[$k]=isset($_SESSION['lp-service01_juniorhighschool02/ac01'][$k])?$_SESSION['lp-service01_juniorhighschool02/ac01'][$k]:'';
    endforeach;
else:
    $_SESSION['lp-service01_juniorhighschool02/ac01']=array();
endif;
...
foreach($dt["db_field"] as $key){
    if(!(isset($_POST['confirm_x']))):
        $_POST[$key]=isset($_SESSION['lp-service01_juniorhighschool02/ac01'][$key])?$_SESSION['lp-service01_juniorhighschool02/ac01'][$key]:$dt[$key];
    endif;
...
isset($_POST["confirm_x"])
    ...
    */
    ...
    if($dt["err"]):
        ...
        $_SESSION['lp-service01_juniorhighschool02/ac01']=$dt;
        #$_SESSION['lp-service01_juniorhighschool02/ac01']=$_POST;
    endif;
...
";
    ...
    $to     = $admin["to"];
    //$to     = "kudo@kipply.jp,moribe@kipply.jp,h_todoroki@kipply.jp";
    //$to     = "furuichi@kipply.jp,moribe@kipply.jp,h_todoroki@kipply.jp";
